...
`c2hs`.
5.  Install other dependencies mentioned in the `depends` section and
`makedepends` section in https://github.com/qwfy/doc-browser/blob/master/aur/PKGBUILD[this file].
You don't need to install mathjax if you don't use Hoogle.

...
|Ctrl+I |focus and clear the search box, but keep the command, if any
|e.g. before: "/pyfoo"; after: "/py"

|Enter or Down |accept query and select the first match |when in the
search box

|ASDFWERTC |open match 1-9

|G+ASDFWERTC |open match 10-18

|V+ASDFWERTC |open match 19-27

|J |select the next match

|K |select the previous match

|Enter |open the selected match |when the selected item has focus

|Tab or Down |select the next match |when the selected item has focus

|Shift+Tab or Up |select the previous match |when the selected item has
focus

|1234567890 |go to the corresponding tab

|Alt+L |go to the next tab

|Alt+H |go to the previous tab

|Ctrl+W |close the current tab

|Y |copy the selected match to clipboard |need executable `xsel` or
`xclip`

|Ctrl+/ |send query to Google |e.g. Ctrl+/ on "/pyfoo" will search
Google for "Python foo"; need executable `xdg-open`

|Ctrl+f |toggle page search

|Alt+n |find next in page search

|Alt+p |find previous in page search

|Esc |close page search |when in search box
|=======================================================================

...
* Supports both DevDocs and Dash docset
* Hoogle integration
* Customizable
...
# will install both the latest of Python (3.x) and Python 2.7.13

# use
#   doc-browser --list-remote-devdocs
# to query available docset and versions
----
...
# to query available docset
----

This will download docsets from kapeli.com, and unpack them to
...
the instructions in link:#configuration[Configuration] section.
...
Problem: Anchors in some Dash's docsets, like Erlang, don't work.

Solution: None, I'm working on this. As a workaround, you can use kbd:[Ctrl+F] to do a page search.
